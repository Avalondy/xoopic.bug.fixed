...
protected:
	...
	int DriftFlag;
	//------------------------------------
	Scalar thetaUpperLimit;// upper limit of the range of the angular distribution
	//------------------------------------
public:
	MaxwellianFlux() {
	  species = NULL;
...
//create isotropic thermal dist
	...
	//-------------------------------------------------------------------------------------------------------------
	void AngularDistr(Vector3& v, const Scalar& thetaU); // make v angular distributed
	void setTheta(const Scalar& theta){thetaUpperLimit = theta;};
	//-------------------------------------------------------------------------------------------------------------
